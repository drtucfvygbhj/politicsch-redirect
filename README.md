# politicsch.ch — redirect to politikch.ch

This repository exists only to serve `politicsch.ch` over **HTTPS** and forward it to
the main site in en (`https://politikch.ch/?lang=en`).
